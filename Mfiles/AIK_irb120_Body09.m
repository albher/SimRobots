function qOpts = AIK_irb120_Body09(eeTform, enforceJointLimits, sortByDistance, referenceConfig)
%AIK_irb120_Body09 Function for generating closed-form inverse kinematics solutions to the DH robot given by the parameters specified below
%   $Revision: $ $Date: $
%
%   Generated on 12-Apr-2024 12:48:23


dhParams = [0 1.5707963267949 0 0;0.4318 0 0 0;0.0203 -1.5707963267949 0.15005 0;0 1.5707963267949 0.4318 0;0 -1.5707963267949 0 0;0 0 0.115 0];
thetaOffsets = [0 0 0 0 0 0];
lastThreeAxesSign = [1 -1 1];
jointLimits = [-2.79 2.79;-1.92 1.92;-2.356 2.356;-4.642 4.642;-1.745 1.745;-4.642 4.642];
...
eeToJt5 = [1 0 0 0;0 6.12323399573677e-17 -1 0;0 1 6.12323399573677e-17 -0.115;0 0 0 1];
